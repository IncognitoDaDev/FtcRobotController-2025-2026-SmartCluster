...
public class SQIDController {
    ...
    public SQIDController(double p, double i, double d)
    {
        this.p=p;
        this.i=i;
        this.d=d;
    ...
    public SQIDController(double p, double i, double d, double lowPassGain)
    {
        this.p=p;
        this.i=i;
        this.d=d;
    ...
    public double update(double target, double value) {
        ...
        return Math.sqrt(error) * p + integral * i + derivative * d;
    }
