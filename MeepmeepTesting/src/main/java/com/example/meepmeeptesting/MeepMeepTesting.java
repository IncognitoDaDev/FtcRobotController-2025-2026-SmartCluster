...
public class MeepMeepTesting {
    public static void main(String[] args) {
         ...
         final Pose2d shootPose = new Pose2d(-12, 12,Math.toRadians(180));
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(new Pose2d(-46.5, 55.5, Math.toRadians(-125)))
...
//                        .splineToLinearHeading(stack1,Math.toRadians(0))
                        ...
                        .setTangent(Math.toRadians(0))
                        .splineToConstantHeading(new Vector2d(-50, -10.5), Math.toRadians(0))
